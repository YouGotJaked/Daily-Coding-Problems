 ...
 * This means 3 peopl entered the building. An exit looks like this:
 ...
 * You can assume that building always starts off and ends up empty, i.e. with 0 people inside.
 */
