 ...
 * If using a language that has no pointes (such as Python), you can assume you have access to get_pointer and dereference_pointer functions that converts between nodes and memeory addresses.
 */
